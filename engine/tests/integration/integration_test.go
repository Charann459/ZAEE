...
// INTEGRATION TESTS — Core engine + Kafka + Redis + PostgreSQL
// These tests verify that the engine successfully communicates with external infrastructure.
// Run against a live docker-compose stack.
//
// To run:
// 1. docker-compose up -d
// 2. go test ./tests/integration/... -tags=integration -v
